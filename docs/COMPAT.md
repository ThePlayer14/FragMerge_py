...
Since the tool is based on the asmodean code, it's probably going to work with the following:
|Release Date   |Publisher      |Title                             |
|----------|---------------|----------------------------------|
...
- 11eyes CrossOver, Steins;Gate, code_18, memo6-nr, memo6-twa, sgmde-360 verifiably works.
